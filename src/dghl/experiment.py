...
import torch
from src.dghl.model import DGHLModel

from src.dghl.utils import de_unfold
from src.dghl.utils_visualization import plot_reconstruction_ts, plot_anomaly_scores
...
def train_DGHL(mc, train_data, test_data, test_labels, train_mask, test_mask, entities, make_plots, root_dir):
    ...
    model = DGHLModel(window_size=window_size, window_step=mc['window_step'], window_hierarchy=window_hierarchy,
